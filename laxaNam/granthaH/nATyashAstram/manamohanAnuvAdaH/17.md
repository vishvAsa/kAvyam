...
6.[^mg3]To provide a composition with many figures of speech (*alaṃkāra*), and Guṇas placed like ornaments, is called Ornateness (*bhūṣaṇa*, lit. ornament).
...
8.[^mg4] Where for the purpose of giving distinction to a case of *double entendre (śleṣa*), a less-known meaning is called forth along with the well-known meanings, it is called Brilliance (*śobhā*, lit. beauty).
...
9\. When by a sentence expressing a similar situation a suggestion is made by clever people to accomplish some objects, it is called Prarallelism (*udāharaṇa*, lit. example).[^mg5]
...
10\. When a brief and pleasing sentence by the force of its [tactful] use achieves the desired object, it is called Causation (*hetu*)[^mg6].
...
11\. When due to many considerations a sentence is brought to an end without fully communicating the essential theme [in view], it is called Hesitation (*saṃśaya*, lit. doubt).[^mg7]
